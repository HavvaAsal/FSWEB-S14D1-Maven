...
public class Main {
    public static void main(String[] args) {
        ...
        JuniorDeveloper juniorDeveloper2 = new JuniorDeveloper(1,"ayşe",2222);
        ...
        SeniorDeveloper seniorDeveloper = new SeniorDeveloper(1,"havva",40000);
        System.out.println(seniorDeveloper.toString());
        seniorDeveloper.work();

        HRManager hrManager = new HRManager(1,"kadir",120000,
